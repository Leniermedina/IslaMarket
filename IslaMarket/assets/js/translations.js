...
const translations = {
    es: {
        ...
        "category.ofertas-de-temporada": "Ofertas de temporada",
        "category.mas-vendidos": "Más vendidos",
        "category.lo-que-necesitas": "Lo que necesitas",
        "product.cinta-para-correr": "Cinta para Correr",
        "product.cafe-molido-premium": "Café Molido Premium",
        "product.horno-tostador": "Horno Tostador",
        "product.auriculares-bluetooth": "Auriculares Bluetooth",
        "product.smartwatch-deportivo": "Smartwatch Deportivo",
        "product.aceite-de-oliva-extra": "Aceite de Oliva Extra",
        "product.licuadora-profesional": "Licuadora Profesional",
        "product.mat-de-yoga": "Mat de Yoga",
        "product.camiseta-deportiva": "Camiseta Deportiva",
        "product.martillo-profesional": "Martillo Profesional",
        "product.zapatillas-de-running": "Zapatillas de Running",
        "product.bicicleta-estatica": "Bicicleta Estática",
        "product.jugo-de-frutas-natural": "Jugo de Frutas Natural",
        "product.barra-de-cereales": "Barra de Cereales",
        "product.microondas-digital": "Microondas Digital",
        "product.lavadora-compacta": "Lavadora Compacta",
        "product.tablet-10-pulgadas": "Tablet 10 Pulgadas",
        "product.camara-de-accion": "Cámara de Acción",
        "product.camisa-casual": "Camisa Casual",
        "product.pantalon-de-jeans": "Pantalón de Jeans",
        "product.destornillador-multifuncion": "Destornillador Multifunción",
        "product.sierra-electrica": "Sierra Eléctrica",
        "product.envios-maritimos": "Envíos marítimos",
        "product.envios-aereos": "Envíos aéreos",
    ...
    en: {
        ...
        "category.electrodomesticos": "Appliances",
        "category.alimentos": "Food",
        "category.accesorios-deportivos": "Sports Accessories",
        "category.todos": "All products",
        "product.envios-terrestres": "Ground Shipping",
        "product.servicio-de-paqueterias-y-combos": "Package & Combo Service",
        "product.recargas-internacionales": "International Top-Ups",
        "product.envios-aereos": "Air Shipping",
        "product.envios-maritimos": "Sea Shipping",
        "product.sierra-electrica": "Electric Saw",
        "product.destornillador-multifuncion": "Multifunction Screwdriver",
        "product.pantalon-de-jeans": "Jeans Pants",
        "product.camisa-casual": "Casual Shirt",
        "product.camara-de-accion": "Action Camera",
        "product.tablet-10-pulgadas": "10-inch Tablet",
        "product.lavadora-compacta": "Compact Washing Machine",
        "product.microondas-digital": "Digital Microwave",
        "product.barra-de-cereales": "Cereal Bar",
        "product.jugo-de-frutas-natural": "Natural Fruit Juice",
        "product.bicicleta-estatica": "Stationary Bike",
        "product.zapatillas-de-running": "Running Shoes",
        "product.martillo-profesional": "Professional Hammer",
        "product.camiseta-deportiva": "Sports T-Shirt",
        "product.mat-de-yoga": "Yoga Mat",
        "product.licuadora-profesional": "Professional Blender",
        "product.aceite-de-oliva-extra": "Extra Virgin Olive Oil",
        "product.smartwatch-deportivo": "Sports Smartwatch",
        "product.auriculares-bluetooth": "Bluetooth Headphones",
        "product.horno-tostador": "Toaster Oven",
        "product.cafe-molido-premium": "Premium Ground Coffee",
        "product.cinta-para-correr": "Treadmill",
        // === Navigation ===
        "nav.home": "Home",
        "nav.shop": "Shop",
        "nav.about": "About",
